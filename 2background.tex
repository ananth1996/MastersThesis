...
We will explain in future chapters how hierarchies in social network is intrinsically linked to the theory of status in directed signed networks. We show how to use the concept of agony for a directed signed graph $G$ to quantify the violation of status theory and therefore, utilize it as a feature to predict the sign of an edge.
