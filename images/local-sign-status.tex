...
\begin{tikzpicture}
    ...
    (convertL) edge[draw=none] node[text width=3cm,align=center] {Convert\\ negative edges} (convertR)
  ...
  \end{tikzpicture}
    ...
    \caption{Local Singed Network prediction based on status theory.}
    \label{}
\end{figure}