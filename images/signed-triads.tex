...
\begin{tikzpicture}
    ...
    \begin{scope}[>={Stealth[black]},
        ...
        (v3) edge[positive] node[below=0.05cm] {$+$} node[below=1cm] {$B_1$}  (v1)      
        ;
        \path 
        (v4) edge[negative] node[above left=0.1mm and 0.1mm] {$-$} (v5)
        (v5) edge[negative] node[above right=0.1mm and 0.1mm] {$-$} (v6) 
        (v6) edge[positive] node[below=0.05cm] {$+$} node[below=1cm] {$B_2$}  (v4)      
        ;
        \path 
        (v7) edge[positive] node[above left=0.1mm and 0.1mm] {$+$} (v8)
        (v8) edge[positive] node[above right=0.1mm and 0.1mm] {$+$} (v9) 
        (v9) edge[negative] node[below=0.05cm] {$-$} node[below=1cm] {$B_3$}  (v7)      
        ;
        \path 
        (v10) edge[negative] node[above left=0.1mm and 0.1mm] {$-$} (v11)
        (v11) edge[negative] node[above right=0.1mm and 0.1mm] {$-$} (v12) 
        (v12) edge[negative] node[below=0.05cm] {$-$} node[below=1cm] {$B_4$}  (v10)      
        ;
    \end{scope}
  \end{tikzpicture}
