...
Consequently, we can bootstrap these models to start from the first available RfA and iteratively learn and predict all the votes present in the \wikirfa dataset.
Thus, when these model predict a vote in a RfA, they will possess the information from votes cast in all the RfA that happened previously.
These models have a much better real-world importance and usability in terms of predicting future elections.
